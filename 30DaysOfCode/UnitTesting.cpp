...
vector<int> TestDataEmptyArray::val = {};
...
public:
    ...
    {
        return minimum_index(val);
    }

};
vector<int> TestDataUniqueValues::val = {3,9,5,8,2};
...
vector<int> TestDataExactlyTwoDifferentMinimums::val = {3,9,2,8,2};
